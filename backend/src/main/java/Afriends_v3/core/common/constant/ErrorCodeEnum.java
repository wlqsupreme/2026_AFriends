package Afriends_v3.core.common.constant;
...
public enum ErrorCodeEnum {
     ...
     * 书籍不存在
     */
    USER_BOOK_NOT_EXIST("A0401", "书籍不存在"),

    /**
     * 章节不存在
     */
    USER_CHAPTER_NOT_EXIST("A0402", "章节不存在"),

    /**
     * 章节内容为空
     */
    USER_CHAPTER_CONTENT_EMPTY("A0403", "章节内容为空"),

    /**
     * 书籍分类未设置
     */
    USER_BOOK_CATEGORY_EMPTY("A0404", "书籍分类未设置");

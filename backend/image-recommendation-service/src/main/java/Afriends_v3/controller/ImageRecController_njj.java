...
public class ImageRecController_njj {
    ...
    // 图片控制器ImageRecController_njj.java中修改
    @Value("${app.recommendation.default.limit:10}")
    private Integer defaultLimit;
    @Value("${app.recommendation.default.soft-tag-weight:70}")
    private Integer defaultSoftTagWeight;
    @Value("${app.recommendation.default.hard-tag-weight:25}")
    private Integer defaultHardTagWeight;
    @Value("${app.recommendation.default.popularity-weight:10}")
